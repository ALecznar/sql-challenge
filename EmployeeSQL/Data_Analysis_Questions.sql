...
-- question 1 list the employee number, last name, first name, sex and salary for each employee.
...
-- Question 5 List first name, last name, and sex of each employee whose first name 
...
SELECT last_name, COUNT(*) AS shared_name
FROM employees
GROUP BY last_name
ORDER BY shared_name DESC;